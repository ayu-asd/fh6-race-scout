...
const M = {
  ...
  RaceNachiRun: { zh: '那智山道赛', alt: '那智竞速/那智奔袭赛 (旧查询名)', confidence: 'verified' },
  RaceNorikuraDescent: { zh: '乘鞍下坡赛', confidence: 'source' },
  RaceOkishinaimuraRun: { zh: '兴志内村山道赛', alt: '兴志内村竞速/冲品村奔袭赛 (旧查询名)', confidence: 'verified' },
  ...
  RaceSunflowerCharge: { zh: '向日葵冲锋赛', alt: '向日葵攀爬赛 (旧名)', confidence: 'verified' },
  ...
  // ---- 泥地竞速赛 (20) ----
  RaceAirfieldTrail: { zh: '机场径道赛', confidence: 'source' },
  RaceBambooForestScramble: { zh: '竹林攀爬赛', confidence: 'source' },
  RaceCherryFieldTrail: { zh: '樱桃园径道赛', confidence: 'source' },
  RaceChiheisenScramble: { zh: '地平线攀爬赛', confidence: 'verified' },
  RaceHirosakiScramble: { zh: '弘前攀爬赛', confidence: 'verified' },
  RaceHokubuTrail: { zh: '北部径道赛', confidence: 'source' },
  RaceHorizonStadiumScramble: { zh: '地平线体育场攀爬赛', confidence: 'source' },
  RaceIneScramble: { zh: '伊根攀爬赛', confidence: 'source' },
  RaceItoTrail: { zh: '伊东径道赛', confidence: 'verified' },
  RaceKawazuNanadaruScramble: { zh: '河津七泷攀爬赛', confidence: 'source' },
  'RaceKinkaku-jiTrail': { zh: '金阁寺径道赛', confidence: 'source' },
  RaceLegendIslandTrail: { zh: '传奇岛径道赛', confidence: 'source' },
  RaceNukabiraTrail: { zh: '糠平径道赛', confidence: 'source' },
  RaceOyashirazuTrail: { zh: '亲不知径道赛', confidence: 'source' },
  ...
  RaceTakashiroTrail: { zh: '高城径道赛', confidence: 'source' },
  RaceWaterfallTrail: { zh: '瀑布径道赛', alt: 'ForzaLabs 未收录, 玩家游戏内截图实锤 5.8km (OCR 误读: 藻布/漂布)', confidence: 'verified' },
...
await writeFile(
  ...
  JSON.stringify(
    {
      note: 'ForzaLabs race image key -> 游戏内简中名。四个地平线巨献: 歌莉娅(环岛)/迎战巨汉(环首都高)/苦行赛(泥地拉力)/巨人对决(越野), 经玩家游戏内核实。游戏内还有 ForzaLabs 未收录比赛(曾尔环道赛/东京铁道冲刺赛/瀑布径道赛/计时赛x5/序章等), 识别到时会出候选下拉。',
      map: M,
    },
    null,
    2
